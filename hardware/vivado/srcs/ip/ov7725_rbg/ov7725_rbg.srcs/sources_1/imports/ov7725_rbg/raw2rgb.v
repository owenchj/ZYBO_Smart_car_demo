...
#(
	...
	parameter   [5:0]   RAW_PIX_W = 8,
	parameter   [5:0]   RGB_PIX_W = 8
)
(
	//global clock
	...
	input [RAW_PIX_W-1:0]	per_img_RAW,		//Prepared Image data 8 Bit RAW Data
...
wire		[RAW_PIX_W-1:0]	matrix_p11, matrix_p12, matrix_p13;	//3X3 Matrix output
wire		[RAW_PIX_W-1:0]	matrix_p21, matrix_p22, matrix_p23;
wire		[RAW_PIX_W-1:0]	matrix_p31, matrix_p32, matrix_p33;
Matrix_Generate_3X3	
#(
...
begin
	if(!rst_n)
		...
		if(matrix_frame_href_end)
			line_cnt <= (line_cnt < IMG_VDISP - 1'b1) ? line_cnt + 1'b1 : 13'd0;
		else
			line_cnt <= line_cnt;
		end
	else
